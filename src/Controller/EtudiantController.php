...
require_once __DIR__ . '/BaseController.php'; // <-- inclut BaseController
...
public function index(Request $request): void
{
    ...
    // Total d'étudiants et liste paginée
    $total = $this->etudiantDao->countAll();
    $etudiants = $this->etudiantDao->findAllPaginated($page, $size);

    $totalPages = max(1, (int)ceil($total / max(1, $size)));

    // Passage des variables à la vue
    $this->render('etudiant/index', [
        'etudiants' => $etudiants,
        'page' => $page,
        'size' => $size,
        'total' => $total,
    ...
    public function show(Request $request, array $params): void
{
    ...
    // Ici on envoie $e à la vue
    $this->render('etudiant/show', ['e' => $e]);
}

    public function create(): void
    {
        $filieres = $this->filiereDao->findAll();
        $this->render('etudiant/create', ['filieres' => $filieres, 'errors' => []]);
    }
    ...
    public function store(Request $request): void
    {
        ...
        if ($errors) {
            $filieres = $this->filiereDao->findAll();
            $this->render('etudiant/create', ['filieres' => $filieres, 'errors' => $errors, 'old' => $data]);
            return;
        }
    ...
    public function edit(Request $request, array $params): void
    {
        ...
        $filieres = $this->filiereDao->findAll();
        $this->render('etudiant/edit', ['e' => $e, 'filieres' => $filieres, 'errors' => []]);
    }
    ...
    public function update(Request $request, array $params): void
    {
        ...
        if ($errors) {
            $filieres = $this->filiereDao->findAll();
            $this->render('etudiant/edit', ['e' => array_merge($e, $data), 'filieres' => $filieres, 'errors' => $errors]);
            return;
        }
